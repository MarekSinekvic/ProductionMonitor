...
} //{new Date(new Date(table.fullData[table.detailsTarget].check_end_date)-new Date(table.fullData[table.detailsTarget].check_start_date)).toLocaleTimeString()}
    ...
    return (
      <Stack>
        ...
        <Flex alignItems={'center'} gap={3}>
          {normalizeDate(table.fullData[table.detailsTarget].check_start_date)} <PiArrowFatLineRightThin/> {normalizeDate(table.fullData[table.detailsTarget].check_end_date)}
        </Flex>
